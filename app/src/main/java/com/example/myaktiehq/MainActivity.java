...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreat: View ist fertig gebaut");
    }
    ...
    protected void onPause() {
        super.onPause();
        // hier sollten vorgenommene Änderungen in der Activity gespeichert werden
    ...
    protected void onDestroy() {
        super.onDestroy();
        Log.d(TAG, "onDestroy: ");
        // kappen von Datenbanken etc..
        // hier alle Daten speichern, die noch benötigt werden!!
    }
